// ============================================
// 注册页 (B2 换装, 2026-09-25)
//   行为完全保留: 邀请制 / 推荐码 / 自助注册 / 自动登录
//   B2 收口:
//     - AppTheme.bgWarm → context.tokens.surface (跟随主题)
//     - 硬编码 AppTheme.primaryLight.withOpacity(0.25) → context.tokens.primarySurface (语义令牌)
//     - 字号 / 圆角 / 间距全部走 AppType / AppRadius / AppSpace
//     - 主按钮 → FilledButton (已用, 高度 buttonLgHeight)
// ============================================
...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  void _toast(String msg) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text(msg, style: const TextStyle(fontSize: AppType.md))),
    );
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              // 注册按钮 —— FilledButton, 整宽 + buttonLgHeight
              SizedBox(
              ...
              Center(
                child: TextButton(
                  ...
                  child: const Text(
                    '已有账号? 去登录',
                    style: TextStyle(fontSize: AppType.sm),
                  ),
                ),
              ),
            ],
